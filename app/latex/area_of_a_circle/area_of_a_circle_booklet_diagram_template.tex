...
\begin{minipage}{.4\textwidth}
  \begin{align*}
  \text{Area} &= \pi r^2 \\
  \text{Area} &= \pi \times (<<calc_radius_value>>\,\text{cm})^2 \\
  \text{Area} &\approx <<calcarea_value>> \,\text{cm}^2
  \end{align*}
\end{minipage}