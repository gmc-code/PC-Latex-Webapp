...
from .perimeter_of_a_rectangle_functions import get_perimeter_of_a_rectangle_dict, get_side_pairs, get_rotations_shuffled
...
def create_booklet_perimeter_of_a_rectangle(numq=20, title_text="perimeter of a Rectangle", file_type="pdf", show_dimension_lines_bool=True, show_vertices_bool=True, allow_rotation_bool=True, units="Random"):

    # calcside_value1, calcside_value2, calc_perimeter_value
    ...
    def make_diagram_wrapper(tex_diagram_template_txt, idx):
        ...
        return make_diagram(tex_diagram_template_txt, tex_keys_q, get_perimeter_of_a_rectangle_dict(side_pair, rotation, show_dimension_lines_bool, show_vertices_bool, allow_rotation_bool, units))

    return create_booklet(
        numq,
        title_text,
        make_diagram_wrapper,
        "perimeter_of_a_rectangle_booklet_template.tex",
        "perimeter_of_a_rectangle_booklet_ans_template.tex",
        "perimeter_of_a_rectangle_booklet_diagram_template.tex",
        "perimeterrect",
        file_type,
    )
