...
from .circumference_of_a_circle_functions import get_circumference_of_a_circle_dict, get_random_float_1dp_list, get_rotations_shuffled
...
def create_booklet_circumference_of_a_circle(numq=20, title_text="circumference of a circle", file_type="pdf", show_dimension_lines_bool=True):
    ...
    def make_diagram_wrapper(tex_diagram_template_txt, idx):
        ...
        return make_diagram(tex_diagram_template_txt, tex_keys_q, get_circumference_of_a_circle_dict(radius, rotation, show_dimension_lines_bool))

    return create_booklet(
            numq,
            title_text,
            make_diagram_wrapper,
            "circumference_of_a_circle_booklet_template.tex",
            "circumference_of_a_circle_booklet_ans_template.tex",
            "circumference_of_a_circle_booklet_diagram_template.tex",
            "circC",
            file_type,
        )
