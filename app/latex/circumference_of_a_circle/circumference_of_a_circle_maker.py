...
def create_booklet_circumference_of_a_circle(numq=20, title_text="circumference of a circle", file_type="pdf", show_dimension_lines_bool=True, allow_rotation_bool=True, units="Random"):
    ...
    def make_diagram_wrapper(tex_diagram_template_txt, idx):
        ...
        return make_diagram(tex_diagram_template_txt, tex_keys_q, get_circumference_of_a_circle_dict(radius, rotation, show_dimension_lines_bool, allow_rotation_bool, units))
