...
from .angles_in_iso_triangle_functions import get_angles_in_iso_triangle_dict
...
def create_booklet_iso_angle_in_triangle(numq=16, title_text="Angles in an Isosceles Triangle", num=3, file_type="pdf"):

    def make_diagram_wrapper(tex_diagram_template_txt):
        return make_diagram(tex_diagram_template_txt, get_angles_in_iso_triangle_dict(num))

    return create_booklet(
        numq,
        title_text,
        make_diagram_wrapper,
        "angles_in_iso_triangle_booklet_template.tex",
        "angles_in_iso_triangle_booklet_ans_template.tex",
        "angles_in_iso_triangle_booklet_diagram_template.tex",
        "isotri",
        file_type,
    )
