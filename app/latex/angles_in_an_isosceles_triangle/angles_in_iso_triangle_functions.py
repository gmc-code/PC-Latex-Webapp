...
def get_angles_in_iso_triangle_dict(unknown_ang_num):
    ...
    match unknown_ang_num:
        case 1:
            ...
            if showAorB == 1:
                # show A
                kv["angleADisplayValue"] = rf"${angleAValue}^\circ$"
            ...
            kv["CalcLine3"] = fr"&= 180^\circ - {angleABValue}^\circ"
        ...
        case 2:
            ...
            if unkownAorB == 1:
                ...
                kv["angleBDisplayValue"] = ""
                kv["angleCDisplayValue"] = fr"${angleCValue}^\circ$"
            else:
                #  theta is  B
                kv["angleADisplayValue"] = ""
            ...
            kv["CalcLine1"] = rf"\text{{$\theta^\circ$}} &= \frac{{(180^\circ - \angle \text{{{angleCLabel}}})}}{2}"
            kv["CalcLine2"] = rf"&= \frac{{(180^\circ - {angleCValue}^\circ)}}{2}"
            kv["CalcLine3"] = rf"&= \frac{{{180-angleCValue}^\circ}}{2}"
            kv["CalcLine4"] = rf"&= {angleAValue}^\circ"

            kv["CalcLine1_q"] = rf"\text{{$\theta^\circ$}} &= \frac{{(180^\circ - \angle \text{{{gaps}}})}}{2}"
            kv["CalcLine2_q"] = rf"&= \frac{{(180^\circ - {gaps}^\circ)}}{2}"
            kv["CalcLine3_q"] = rf"&= \frac{{{gaps}^\circ}}{2}"
            kv["CalcLine4_q"] = rf"&= {gaps}^\circ"
