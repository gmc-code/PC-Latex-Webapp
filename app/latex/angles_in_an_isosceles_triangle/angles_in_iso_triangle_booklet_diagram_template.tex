\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.2, baseline=(current bounding box.north)]
    ...
    \begin{scope}[rotate=<<rotationAngleValue>>]
      ...
      \draw ($(A)!0.23cm!(B)$) arc [start angle=0, end angle=<<angleAValue>>, radius=0.23cm];
      \draw ($(A)!0.3cm!(B)$) arc [start angle=0, end angle=<<angleAValue>>, radius=0.3cm];
      \draw ($(B)!0.23cm!(C)$) arc [start angle=180-<<angleBValue>>, end angle=180, radius=0.23cm];
      ...
      \node at ($(A)!0.55cm!(midBC)$) {<<angleADisplayValue>>};

      \coordinate (midAC) at ($(A)!0.5!(C)$);
      \node at ($(B)!0.55cm!(midAC)$) {<<angleBDisplayValue>>};

      \coordinate (midAB) at ($(A)!0.5!(B)$);
      \node at ($(C)!0.55cm!(midAB)$) {<<angleCDisplayValue>>};
