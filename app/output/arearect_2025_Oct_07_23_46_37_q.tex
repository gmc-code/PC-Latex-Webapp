...
\vspace{-3mm}\par
\textbf{Volume of a Rectangular Prism: Questions} \vspace{1pt}\hrule
}
...
\begin{minipage}{.4\textwidth}
  \begin{align*}
    \text{Volume} &= lwH \\
    \text{Volume} &= \dotuline{~~~~~~~} \,\text{<<calc_units>>} \times \dotuline{~~~~~~~} \,\text{<<calc_units>>} \times \dotuline{~~~~~~~} \,\text{<<calc_units>>} \\
    \text{Volume} &= \dotuline{~~~~~~~} \,\text{<<calc_units>>}\dotuline{~~~}
  \end{align*}
\end{minipage}
